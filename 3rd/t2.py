...
def main():
    ...
    button1 = tk.Button(frame_right, text="학생 관리", width=200, height=1, command=lambda: Router.open_t3(root))
    button1.pack(side="top", pady=10)
    button2 = tk.Button(frame_right, text="암호 변경", width=200, height=1, command=lambda: Router.open_t4(root))
    button2.pack(side="top", pady=10)
    button3 = tk.Button(frame_right, text="로그아웃", width=200, height=1, command=lambda: Logout.logout(root))
    button3.pack(side="top", pady=10)
    button4 = tk.Button(frame_right, text="종료", width=200, height=1, command=root.quit)
