...
def main():
    ...
    ent_id = tk.Entry(frame1, width=35, textvariable=ent_id_var)
    ...
    ent_pw = tk.Entry(frame2, width=35, textvariable=ent_pw_var)
    ...
    btn_login = tk.Button(frame3, text="로그인", command=lambda: Login.login(ent_id_var.get(), ent_pw_var.get()))
