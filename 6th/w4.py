...
from auth.account import change_password
...
def main():
    ...
    entry2 = tk.Entry(frame2, width=20, textvariable=entry2_var, validate="key", validatecommand=vcmd)
    ...
    entry3 = tk.Entry(frame3, width=20, textvariable=entry3_var, validate="key", validatecommand=vcmd)
    entry3.pack(side="left")

    frame4 = tk.Frame(main)
    frame4.pack(side="top", anchor="e", pady=5)
