...
from events import studentsDAO
...
def main():
    ...
    combo1 = ttk.Combobox(frame1, values=majors1, state="readonly")
    ...
    scroll1 = ttk.Scrollbar(frame2, orient="vertical", command=tree1.yview)
    ...
    frame3_1.pack(side="top", pady=5)
    label5 = tk.Label(frame3, text="학번")
    ...
    frame3_2.pack(side="top", pady=5)
    label7 = tk.Label(frame3_2, text="이메일")
    label7.pack(side="left", padx=5)
    entry7 = tk.Entry(frame3_2, width=23)
    ...
    combo8 = ttk.Combobox(frame3_3, values=majors2, state="readonly")
    ...
    button6 = tk.Button(frame3_5, text="메인화면", width=23, command=lambda: router.route_w3(root))
    button6.pack(side="left", padx=5)

    frame3_4 = tk.Frame(frame3)
    frame3_4.pack(side="bottom", pady=5)
    button2 = tk.Button(frame3_4, text="추가", width=10, command=lambda: studentsDAO.onclick_add(tree1, combo1, entry2, entry3, entry5, entry6, entry7, combo8, combo9, button4))
    button2.pack(side="left", padx=5)
    button3 = tk.Button(frame3_4, text="저장", width=10, command=lambda: studentsDAO.onclick_save(tree1, entry5, entry6, entry7, combo8, combo9))
    button3.pack(side="left", padx=5)
    button4 = tk.Button(frame3_4, text="삭제", width=10, state="disabled", command=lambda: studentsDAO.onclick_delete(tree1, entry5, entry6, entry7, combo8, combo9, button4))
