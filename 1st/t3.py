...
# 추가 버튼
button2 = tk.Button(root, text="추가", width=10, command=lambda: Query.on_click_add(entry1, entry2, entry3, entry4, entry5, combo2, combo3))
button2.grid(row=6, column=5)

# 저장 버튼
button3 = tk.Button(root, text="저장", width=10, command=lambda: Query.save_start(entry3.get(), entry4.get(), entry5.get(), combo2.get(), combo3.get(), tree))
button3.grid(row=6, column=6)

# 삭제 버튼
button4 = tk.Button(root, text="삭제", width=10, state="disabled", command=lambda: Query.delete(entry3.get(), entry4.get(), entry5.get(), combo2.get(), combo3.get(), button4, tree))
