...
def main():
    ...
    frame3.pack(side="top", pady=5, fill="x")
    ...
    frame4.pack(side="bottom", pady=5, anchor="e")
    button1 = tk.Button(frame4, text="저장", state="disabled", command=lambda: change_password(entry1, entry2, entry3, button1, root))
