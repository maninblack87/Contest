...
def main():
    ...
    button1 = tk.Button(frame1, text="검색", command=lambda:search(combo1, entry2, entry3, tree1, button4))
    ...
    combo8 = ttk.Combobox(frame3_3, width=14, values=majors2, state="readonly")
    ...
    button5 = tk.Button(frame3_5, text="로그아웃", width=10, command=lambda: logout(root))
    ...
    button2 = tk.Button(frame3_4, text="추가", width=10, command=lambda: stdDAO.onclick_add(combo1, entry2, entry3, entry5, entry6, entry7, combo8, combo9, tree1, button4))
    ...
    button4 = tk.Button(frame3_4, text="삭제", width=10, state="disabled", command=lambda: stdDAO.onclick_delete(tree1, entry5, entry6, entry7, combo8, combo9, button4))
    ...
    root.bind("<<TreeviewSelect>>", lambda e: onselect_tree(tree1, entry5, entry6, entry7, combo8, combo9, button4))
