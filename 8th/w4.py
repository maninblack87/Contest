...
def main():
    ...
    entry1 = tk.Entry(frame1, show="*", textvariable=entry1_var, validate="key", validatecommand=vcmd)
    ...
    entry2 = tk.Entry(frame2, show="*", textvariable=entry2_var, validate="key", validatecommand=vcmd)
    ...
    entry3 = tk.Entry(frame3, show="*", textvariable=entry3_var, validate="key", validatecommand=vcmd)
